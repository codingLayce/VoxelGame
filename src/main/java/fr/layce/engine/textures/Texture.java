...
import fr.layce.engine.utils.IOUtils;
...
public class Texture {
    ...
    public static void cleanup() {
        textures.forEach(Texture::delete);
    }
    ...
    public static Texture loadTexture(String path) {
        ...
        String file = "res/" + path + ".PNG";
        System.out.println(file);

        try {
            image = IOUtils.ioResourceToByteBuffer(file, 1024);
        } catch (IOException e) {
            System.err.println("Error while reading Texture file and convert it into ByteBuffer!");
            e.printStackTrace();
            System.exit(-1);
        }
